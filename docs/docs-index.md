...
| 概要 | `README.md` | プロジェクト概要と主要ドキュメント案内 | 初期セットアップや用途に変更があったとき | ✅ 2025-11-05（Pi5 と共有する API トークン方針を追記） |
...
| 要件/ロードマップ | `docs/requirements.md` | 要件、優先度、決定事項、未対応タスク | 要件・合意事項が変わったとき | ✅ 2025-11-05（Pi5/Window A と同一トークンを共有する運用を追記） |
